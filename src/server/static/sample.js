(function ($) {
  var map,                                      // This is the Google map
    ...
    markerImage = new google.maps.MarkerImage('/static/purple_circle.png',
  ...
  // listeners here.
  function initialize() {
    var center = new google.maps.LatLng(19.3606953,-99.2829132);
    var mapOptions = {
      zoom: 18,
      center: center
    };
    ...
    var bounds = new google.maps.LatLngBounds(
      new google.maps.LatLng(19.360757,-99.282707),
      new google.maps.LatLng(19.360685,-99.282532));

    var srcImage = '/static/piso2';
